        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50/80 to-sky-50/50 border border-blue-100/80 p-6 rounded-[20px] text-center space-y-3 flex flex-col items-center justify-between shadow-[0_2px_12px_rgba(37,99,235,0.05)] hover:shadow-[0_8px_28px_rgba(37,99,235,0.1)] hover:-translate-y-0.5 hover:border-blue-200 transition-all duration-300 group">
              ...
              <div>
                <span className="text-xs font-mono text-slate-400 block uppercase tracking-wider font-bold">Phone Support</span>
                <span className="text-base font-semibold text-slate-800 font-sans block mt-1.5">+91 70076 87896</span>
              </div>
              <a
                href="tel:+917007687896"
                className="w-full text-center py-2 bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 rounded-lg font-mono text-xs font-bold tracking-wider transition-colors"
              >
                CALL NOW
              </a>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50/80 to-sky-50/50 border border-blue-100/80 p-6 rounded-[20px] text-center space-y-3 flex flex-col items-center justify-between shadow-[0_2px_12px_rgba(37,99,235,0.05)] hover:shadow-[0_8px_28px_rgba(37,99,235,0.1)] hover:-translate-y-0.5 hover:border-blue-200 transition-all duration-300 group">
              ...
              <div>
                <span className="text-xs font-mono text-slate-400 block uppercase tracking-wider font-bold">Email Directory</span>
                <span className="text-base font-semibold text-slate-800 font-sans block mt-1.5 truncate max-w-[220px]">iamhindia2021@gmail.com</span>
              </div>
              <a
                href="mailto:iamhindia2021@gmail.com"
                onClick={handleEmailClick}
                className={`w-full text-center py-2 border rounded-lg font-mono text-xs font-bold tracking-wider transition-all duration-200 ${
                  copied 
          ...
          {/* Verification Shield */}
          <div className="bg-emerald-50/40 border border-emerald-100/70 rounded-xl p-5 flex gap-4 text-sm text-slate-600 shadow-[0_1px_4px_rgba(0,0,0,0.005)]">

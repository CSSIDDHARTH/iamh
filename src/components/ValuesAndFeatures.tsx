            ...
            return (
              ...
              >
                <div className="space-y-4.5">
                  {/* Icon Shield */}
                  <div className="w-14 h-14 flex items-center justify-center bg-blue-100/60 text-blue-700 rounded-lg border border-blue-200/50 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 shadow-2xs">
                    <IconComp className="w-6.5 h-6.5 stroke-[1.5]" />
                  </div>

                  {/* Text */}
                  <div className="space-y-2.5">
                    <h3 className="font-display font-bold text-slate-900 text-xl tracking-tight group-hover:text-iamh-navy transition-colors">
                      {val.title}
                    </h3>
                ...
                <div className="mt-8 pt-4 border-t border-slate-100/80 flex items-center justify-between text-sm font-mono tracking-wider uppercase text-slate-400">

    ...
    <section id="participation" className="py-20 bg-slate-50/70 border-t border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-blue-50 text-blue-800 text-sm font-bold uppercase tracking-wider mb-4 border border-blue-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all duration-300 flex flex-col">
            ...
            <p className="text-sm font-semibold text-emerald-700 mb-3 uppercase tracking-wider">Learners</p>
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center gap-1.5 text-sm font-semibold text-emerald-700">
          ...
          <div className="bg-white rounded-2xl p-6 border border-blue-200 shadow-sm hover:shadow-md hover:border-blue-400 transition-all duration-300 flex flex-col relative">
            ...
            <p className="text-sm font-semibold text-blue-700 mb-3 uppercase tracking-wider">Educators</p>
            <ul className="space-y-1.5 text-sm text-slate-600 flex-1">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center gap-1.5 text-sm font-semibold text-blue-700">
              <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md hover:border-amber-300 transition-all duration-300 flex flex-col">
            ...
            <p className="text-sm font-semibold text-amber-700 mb-3 uppercase tracking-wider">Institutional Head</p>
            <ul className="space-y-1.5 text-sm text-slate-600 flex-1">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center gap-1.5 text-sm font-semibold text-amber-800">
              <CheckCircle2 className="w-3.5 h-3.5 shrink-0" />
        ...
        {/* Compact footnote */}
        <div className="max-w-3xl mx-auto px-5 py-3 rounded-xl bg-white border border-slate-200 text-center text-sm text-slate-500 shadow-xs">
